...
- (void)buildSectionFoledStatus:(NSInteger)section
{
    if (sectionFoldedStatus == nil)
        sectionFoldedStatus = [NSMutableDictionary dictionary];
...
- (void)setUpTopHeaderScrollView
{
    ...
    for (NSInteger i = 0; i < count; i++) {
        ...
        alignPosition = AlignHorizontalPositionCenter;
        ...
        NSString* columnStr = [NSString stringWithFormat:@"-1_%ld", (unsigned long)i];
        ...
        //add backgroud color
        UIView* bgview = [[UIView alloc] initWithFrame:CGRectMake(self.cellPadding.left, self.cellPadding.top, topHeaderW - self.cellPadding.left - self.cellPadding.right, topHeaderH - self.cellPadding.top - self.cellPadding.bottom)];
        bgview.backgroundColor = self.topHeaderBackgroundColor;
        bgview.clipsToBounds = YES;
        bgview.layer.cornerRadius = self.cellCornerRadius;
...
- (UITableViewCell*)leftHeaderTableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    //add backgroud color
    view = [[UIView alloc] initWithFrame:CGRectMake(self.cellPadding.left, self.cellPadding.top, leftHeaderWidth - self.cellPadding.left - self.cellPadding.right, cellH - self.cellPadding.top - self.cellPadding.bottom)];
    view.backgroundColor = indexPath.row % 2 == 0 ? self.leftHeaderEvenRowColor : self.leftHeaderOddRowColor;
    view.clipsToBounds = YES;
    view.layer.cornerRadius = self.cellCornerRadius;
...
- (UITableViewCell*)contentTableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    for (NSInteger i = 0; i < count; i++) {
        ...
        //add backgroud color
        UIView* bgView = [[UIView alloc] initWithFrame:CGRectMake(self.cellPadding.left, self.cellPadding.top, cellW - self.cellPadding.left - self.cellPadding.right, cellH - self.cellPadding.top - self.cellPadding.bottom)];
        bgView.backgroundColor = indexPath.row % 2 == 0 ? self.contentEvenRowColor : self.contentOddRowColor;
